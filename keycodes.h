...
#define KH_S LCTL_T(KC_S)          // R / Left Ctrl
#define KH_R LALT_T(KC_R)          // S / Left Alt
#define KH_T LSFT_T(KC_T)          // T / Left Shift
#define KH_O RGUI_T(KC_O)          // O / Right Gui
#define KH_I LALT_T(KC_I)          // E / Left Alt (left alt because used as Emacs M- )
